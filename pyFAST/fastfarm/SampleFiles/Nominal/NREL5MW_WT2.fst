...
---------------------- INPUT FILES ---------------------------------------------
"./NREL5MW_ElastoDyn.1_mod.dat"   EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"../5MW_Baseline/NRELOffshrBsline5MW_Blade1.dat"   BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../5MW_Baseline/NRELOffshrBsline5MW_Blade2.dat"   BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../5MW_Baseline/NRELOffshrBsline5MW_Blade3.dat"   BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../5MW_Baseline/NREL5MW_InflowWind.dat"         InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"./NREL5MW_AeroDyn15_mod.dat"           AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"./NREL5MW_ServoDyn.1_mod.dat"           ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
300          TStart          - Time to begin tabular output (s)
